...
<head>
    ...
    <!---- slider --->
    <link href="<?php echo asset('/public/css/bootstrap-slider.css'); ?> " media="all" rel="stylesheet" type="text/css"/>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo asset('public/css/base.css'); ?>" data-rel-css="" />
	...
	<!--<link href="<?php echo asset('public/onesignal/manifest.json'); ?> " media="all" rel="manifest"/>-->
