    	...
    	<div class="row">
        	<div class="col-xs-12 col-md-12">
            	<div class="banner-image en">
                    <a title="Banner Image" href="#"><img class="img-fluid" src="<?php echo e(asset('').'public/images/sale_banners_en.jpg'); ?>" alt="Banner Image"></a>
                </div>
                <div class="banner-image ar">
                    <a title="Banner Image" href="#"><img class="img-fluid" src="<?php echo e(asset('').'public/images/sale_banners_ar.jpg'); ?>" alt="Banner Image"></a>
                </div>
            </div>
        </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="group-banners">
    	<div class="row">
        	<div class="col-xs-12 col-sm-12">
            	<div class="banner-image en">
                    <a title="Banner Image" href="#"><img class="img-fluid" src="<?php echo e(asset('').'public/images/large_banner_en.jpg'); ?>" alt="Banner Image"></a>
                </div>
                <div class="banner-image ar">
                    <a title="Banner Image" href="#"><img class="img-fluid" src="<?php echo e(asset('').'public/images/large_banner_ar.jpg'); ?>" alt="Banner Image"></a>
                </div>
            </div>
        </div>
    </div>
