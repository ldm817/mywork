		...
		<div class="row">
			<div class="col-12 col-md-6 col-lg-7 new-customers">
				...
				<form name="signup" enctype="multipart/form-data" class="form-validate" action="{{ URL::to('/signupProcess')}}" method="post">
                    ...
                    <!--<?="<pre>".print_r($result['commonContent']['pages'], true)."</pre>"?>-->
					<div class="form-group row">
						<label class="col-sm-4 col-form-label"></label>
						<div class="col-sm-8">
							<div class="form-check checkbox-parent">
								<label class="form-check-label">
									<input class="form-check-input checkbox-validate" type="checkbox">@lang('website.Creating an account means you are okay with our')  <a href="{{ URL::to('/page?name='.$result['commonContent']['pages'][3]->slug)}}">@lang('website.Terms and Services')</a>, <a href="{{ URL::to('/page?name='.$result['commonContent']['pages'][1]->slug)}}">@lang('website.Privacy Policy')</a> and <a href="{{ URL::to('/page?name='.$result['commonContent']['pages'][2]->slug)}}">@lang('website.Refund Policy')</a>.
								</label>
